...
INPUT_FILE=$DATASET_DIR/../tests/vshort-users-details-2023.csv
INPUT_FILE=$DATASET_DIR/../tests/vshort-users-score-2023.csv

# Variables del problema
OUTPUT_DIR=./output  # Directorio de salida (se generará en HDFS)
ACTUAL_PROBLEM=$REPO_DIR/item_3  # Directorio actual del problema
